...
// console.log(ålder);   // error, let är block-scoped, inte möjligt att nå utanför blocket. Programmet kraschar här.
// console.log(namn);    // error, const är block-scoped och det är omöjligt att nå const utanför blocket.

/* 
Uppgift 2 - Reflektion:

1. var, let och const fungerar olika i block. Det går att anroppa var utanför blocket. 
   Medan let och const bara fungerar när det gäller inuti blocket.
...
console.log("'3' == 3:", '3' == 3);   // true, den gör typkonvertering
console.log("'3' === 3:", '3' === 3); // false, olika typer. Måste vara exakt samma typ. 

console.log("NaN === NaN:", NaN === NaN); // false, eftersom NaN kan aldrig vara lika med sig själv.
console.log("null == undefined:", null == undefined);   // true och det är för att null är underfined.
console.log("null === undefined:", null === undefined); // false eftersom olika typer.85
...
Man använder null när man vill ge ett tomt värde.
*/
